# [1.15.1](https://github.com/favonia/cloudflare-ddns/compare/v1.15.0...v1.15.1) (2024-12-14)
...
A new Docker tag, `edge-debug`, has been added for those who wish to debug networking issues directly within the image. This image contains the original build environment and is not a minimal Docker image.
