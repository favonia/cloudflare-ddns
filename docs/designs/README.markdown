...
- [`features/detection-filter.markdown`](features/detection-filter.markdown): read when changing `IP4_DETECTION_FILTER`, `IP6_DETECTION_FILTER`, filter syntax, filter placement, or filter-caused abort behavior.
