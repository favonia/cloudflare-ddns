...
| 🧪 `file:<absolute-path>` (available since version 1.16.0) | <p>🧪 Read IP addresses from a local file using the line-based text format described after this table. The path must be absolute.</p><p>The file is re-read on every detection cycle, so you can update it without restarting the updater.</p><p>⚠️ The file must be readable by the user configured by `user: "UID:GID"`.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
