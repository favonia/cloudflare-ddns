...
| `IP4_STATIC`                          | Comma-separated list of static IPv4 addresses to be added as additional `A` records alongside the dynamically detected IPv4 address. For example, `IP4_STATIC=1.2.3.4,5.6.7.8` will create multiple `A` records for each domain: one with the detected dynamic IP and additional ones with the specified static IPs.                                                                                                                                                                                                                                                                                                                           |
| `IP6_STATIC`                          | Comma-separated list of static IPv6 addresses to be added as additional `AAAA` records alongside the dynamically detected IPv6 address. For example, `IP6_STATIC=2001:db8::1,2001:db8::2` will create multiple `AAAA` records for each domain: one with the detected dynamic IP and additional ones with the specified static IPs.                                                                                                                                                                                                                                                                                                       |
