...
const (
	...
	MessageMismatchedRecordAttributes                          // Attributes of DNS records have been changed
	MessageMismatchedWAFListAttributes                         // Attributes of WAF lists have been changed
