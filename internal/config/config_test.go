...
func TestPrintDefault(t *testing.T) {
	...
	gomock.InOrder(
		...
		mockPP.EXPECT().Infof(pp.EmojiConfig, "IP providers:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv4 provider:", "cloudflare.trace"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv4 domains:", "(none)"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv6 provider:", "cloudflare.trace"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv6 domains:", "(none)"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Scheduling:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Timezone:", Some("UTC (UTC+00 now)", "Local (UTC+00 now)")), //nolint:lll
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Update frequency:", "@every 5m"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Update on start?", "true"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Delete on stop?", "false"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Cache expiration:", "6h0m0s"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Timeouts:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IP detection:", "5s"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Record updating:", "30s"),
	)
...
func TestPrintMaps(t *testing.T) {
	...
	gomock.InOrder(
		...
		mockPP.EXPECT().Infof(pp.EmojiConfig, "IP providers:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv4 provider:", "cloudflare.trace"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv4 domains:", "test4.org, *.test4.org"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv6 provider:", "cloudflare.trace"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv6 domains:", "test6.org, *.test6.org"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Scheduling:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Timezone:", Some("UTC (UTC+00 now)", "Local (UTC+00 now)")), //nolint:lll
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Update frequency:", "@every 5m"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Update on start?", "true"),
		...
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "TTL is 1 (auto):", "a, c"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "TTL is 30000:", "b, d"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Proxy for new records:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Proxied:", "a, b"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Unproxied (DNS only):", "c, d"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Timeouts:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IP detection:", "5s"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Record updating:", "30s"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Monitors:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Healthchecks.io:", "(URL redacted)"),
	)
...
func TestPrintEmpty(t *testing.T) {
	...
	gomock.InOrder(
		...
		mockPP.EXPECT().IncIndent().Return(innerMockPP),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "IP providers:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv4 provider:", "none"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IPv6 provider:", "none"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Scheduling:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Timezone:", Some("UTC (UTC+00 now)", "Local (UTC+00 now)")), //nolint:lll
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Update frequency:", "<nil>"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Update on start?", "false"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Delete on stop?", "false"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Cache expiration:", "0s"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Timeouts:"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "IP detection:", "0s"),
		innerMockPP.EXPECT().Infof(pp.EmojiBullet, "%-24s %s", "Record updating:", "0s"),
	)
