...
func TestPrintDefault(t *testing.T) {
	...
	gomock.InOrder(
		...
		printItem(t, innerMockPP, "Record comment:", "(empty)"),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Timeouts:"),
		printItem(t, innerMockPP, "IP detection:", "5s"),
		printItem(t, innerMockPP, "Record updating:", "30s"),
	)
...
func TestPrintValues(t *testing.T) {
	...
	gomock.InOrder(
		...
		printItem(t, innerMockPP, "Record comment:", "\"Created by Cloudflare DDNS\""),
		mockPP.EXPECT().Infof(pp.EmojiConfig, "Timeouts:"),
		printItem(t, innerMockPP, "IP detection:", "5s"),
		printItem(t, innerMockPP, "Record updating:", "30s"),
...
func TestPrintEmpty(t *testing.T) {
	...
	gomock.InOrder(
		...
		printItem(t, innerMockPP, "Record updating:", "0s"),
	)
