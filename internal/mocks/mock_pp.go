...
func (m *MockPP) IsEnabledFor(arg0 pp.VerbosityLevel) bool {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *PPIsEnabledForCall) Do(f func(pp.VerbosityLevel) bool) *PPIsEnabledForCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *PPIsEnabledForCall) DoAndReturn(f func(pp.VerbosityLevel) bool) *PPIsEnabledForCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockPP) SetVerbosity(arg0 pp.VerbosityLevel) pp.PP {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *PPSetVerbosityCall) Do(f func(pp.VerbosityLevel) pp.PP) *PPSetVerbosityCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *PPSetVerbosityCall) DoAndReturn(f func(pp.VerbosityLevel) pp.PP) *PPSetVerbosityCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
